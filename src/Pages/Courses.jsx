...
export default function Courses() {
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl mx-auto px-4 sm:px-5 py-8"
    >
      {/* Banner */}
      <motion.div
        layout
        className="rounded-xl overflow-hidden mb-8 relative h-44 sm:h-56 bg-cover bg-center shadow-lg"
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-sm text-gray-600 hover:text-primary transition hidden sm:inline"
          >
            Clear filters
          </button>
          ...
          <button
            ...
            className="bg-white p-2 rounded-md border sm:hidden"
          >
            Filters
          </button>
        </div>
